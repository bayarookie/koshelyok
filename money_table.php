...
echo '<option'; if (13 == $o) echo ' selected'; echo ' value="13">По группам, конторам</option>';
echo '<option'; if (14 == $o) echo ' selected'; echo ' value="14">По группам, конторам обратно</option>';
